System.register(['./compose', './if', './with', './repeat', './virtual-repeat', './show', './global-behavior', './sanitize-html'], function (_export) {
  var Compose, If, With, Repeat, VirtualRepeat, Show, GlobalBehavior, SanitizeHtmlValueConverter;

  function install(aurelia) {
    aurelia.globalizeResources('./compose', './if', './with', './repeat', './virtual-repeat', './show', './global-behavior', './sanitize-html');
  }
