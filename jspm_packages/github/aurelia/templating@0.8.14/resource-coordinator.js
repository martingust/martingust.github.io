System.register(["aurelia-loader", "aurelia-path", "aurelia-dependency-injection", "aurelia-metadata", "aurelia-binding", "./custom-element", "./attached-behavior", "./template-controller", "./view-engine", "./resource-registry"], function (_export) {
  var Loader, relativeToFile, join, Container, Metadata, ResourceType, Origin, ValueConverter, CustomElement, AttachedBehavior, TemplateController, ViewEngine, ResourceRegistry, _createClass, _classCallCheck, id, ResourceCoordinator, ResourceModule;
  ...
  return {
    ...
    execute: function () {
      ...
      ResourceCoordinator = _export("ResourceCoordinator", (function () {
        ...
        _createClass(ResourceCoordinator, {
