System.register(["./util", "aurelia-binding"], function (_export) {
  var hyphenate, ONE_WAY, TWO_WAY, ONE_TIME, _inherits, _createClass, _classCallCheck, BehaviorProperty, OptionsProperty, BehaviorPropertyObserver;
  ...
  return {
    ...
    execute: function () {
      ...
      OptionsProperty = _export("OptionsProperty", (function (_BehaviorProperty) {
        ...
        _inherits(OptionsProperty, _BehaviorProperty);

        _createClass(OptionsProperty, {
          dynamic: {
